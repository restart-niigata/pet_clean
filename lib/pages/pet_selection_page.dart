// lib/pages/pet_selection_page.dart
...
class PetSelectionPage extends StatelessWidget {
  ...
  // 正式ペットリスト（画像パスは assets/images/ 固定）
  static final List<Map<String, String>> _pets = [
    ...
    {'label': '鳥', 'asset': 'assets/images/bird.png'}, // インコ・文鳥など
